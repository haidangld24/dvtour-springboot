...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler{
    @ExceptionHandler({EntityNotFoundException.class, BookingNotFoundException.class})
    ...
    //Attempting to save the same entity twice throws a DataIntegrityViolationException
